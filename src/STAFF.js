...
//模拟数据库
STAFF.rawData = [{ descrip:'staff', sex: '男', age: 20, name: '张三', id: '主任'},
                 { descrip:'staff', sex: '女', age: 21, name: '赵静', id: '学生'},
				 { descrip:'staff', sex: '女', age: 22, name: '王二麻', id: '学生'},
				 { descrip:'staff', sex: '女', age: 24, name: '李晓婷', id: '实习'},
				 { descrip:'staff', sex: '男', age: 23, name: '张春田', id: '实习'},
				 { descrip:'staff', sex: '男', age: 22, name: '刘建国', id: '学生'},
				 { descrip:'staff', sex: '男', age: 24, name: '张八', id: '主任'},
                 { descrip:'staff。', sex: '男', age: 35, name: '李四', id: '老师'},
				 { descrip:'staff', sex: '男', age: 42, name: '王五', id: '学生'},
				 { descrip:'staff', sex: '男', age: 50, name: '赵六', id: '实习'},
				 { descrip:'staff', sex: '男', age: 60, name: '孙七', id: '实习'}];